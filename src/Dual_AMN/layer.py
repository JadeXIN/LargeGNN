...
class NR_GraphAttention(Layer):
    ...
    def call(self, inputs):
        ...
        # local_triple_size = tf.shape(tf.squeeze(inputs[5]), out_type=tf.int64)
        local_triple_size = tf.squeeze(inputs[5])
        # print('local_triple_size', local_triple_size, type(local_triple_size))
